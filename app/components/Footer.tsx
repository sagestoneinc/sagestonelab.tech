...
const footerLinks = {
  Product: [
    ...
    { label: "Featured Tools", href: "#tools" },
    { label: "Early Access", href: "#contact" },
  ],
  Company: [
    { label: "Sage Stone Inc", href: "#" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6 max-w-xs">
              The innovation arm of Sage Stone Inc. Building tools. Powering
              growth. Engineered for the future of business.
            </p>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="font-grotesk font-semibold text-white text-sm mb-4">{category}</h4>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">
            © {new Date().getFullYear()} Sage Stone Inc. All rights reserved.
          </p>
